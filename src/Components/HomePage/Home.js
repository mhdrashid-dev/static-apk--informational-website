...
function Home() {
  return (
    <div className='min-h-[100vh] w-full bg-gradient-to-tl from-second to-third flex flex-col p-4 mt-12 md:mt-[5.5rem] lg:mt-11 2xl:mt-[5rem] lg:flex-row lg:items-center lg:justify-between'>
        <div data-aos="fade-up" data-aos-duration="1500" className="info h-2/5 pt-10 font-jost md:flex flex-col items-center lg:items-start lg:w-1/2 lg:pl-40 2xl:pl-72">
        ...
        <div data-aos="fade-up" data-aos-duration="1500" className="photo min-h-[70vh] mt-5 relative md:mt-16 lg:w-1/2 xl:mt-28 2xl:mt-10">
